# Auth Offloading Delta Specification
...
- **WHEN** client sends a request to a protected mutating endpoint or admin endpoint without an Authorization header or with an invalid/expired token
