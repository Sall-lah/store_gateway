# CORS Management Specification

## Purpose
Defines centralized CORS policies, preflight OPTIONS 204 handling, dynamic origin reflection, and upstream duplicate header suppression.
