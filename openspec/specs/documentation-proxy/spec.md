# Documentation Proxy Specification

## Purpose
Defines unified reverse proxy routing to downstream microservice documentation portals (Swagger UI, Scalar UI) and raw OpenAPI JSON/YAML schema files across Auth, Product, Order, and User services.
