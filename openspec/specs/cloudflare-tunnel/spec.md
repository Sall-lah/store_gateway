# Cloudflare Tunnel Specification

## Purpose
Defines requirements for the embedded `cloudflared` binary, TLS certificates, and conditional startup lifecycle for zero-ingress edge tunneling.
